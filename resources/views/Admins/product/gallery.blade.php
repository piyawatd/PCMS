...
@section('title')
    SB Admin 2 - Gallery {{$product->title_th}}
@endsection
@section('stylesheet')
...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Gallery {{$product->title_th}}</h1>
    </div>

    <!-- Content Row -->
    <div class="row">
        <div class="col-md-11">
            <form class="needs-validation" id="formdata" novalidate method="post" action="{{ route('adminproductgalleryupdate',$product->id) }}">
                @csrf
                <div class="row top-gallery justify-content-between">
                    ...
                    <div class="col-2">
                        ...
                        <a href="{{route('adminproduct')}}" class="btn btn-danger btn-sm">
                            ยกเลิก
                        </a>
                    </div>
                </div>
